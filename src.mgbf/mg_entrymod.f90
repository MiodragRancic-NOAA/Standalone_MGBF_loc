...
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
!      if(mype==0) then
!        print *,'Before init_mg_parameter'
!      endif
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
!      if(mype==0) then
!        print *,'Before allocate_mg_intstate'
!      endif
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
!      if(mype==0) then
!        print *,'Before lwq_vertrical_coef'
!      endif
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
!      if(mype==0) then
!        print *,'After lwq_vertrical_coef'
!      endif
!TEST->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
