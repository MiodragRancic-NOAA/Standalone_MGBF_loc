...
private sup_vrbeta1_new
private sup_vrbeta1T_new
...
!      call C2S_ens(VM3D,VALL,1-hx,im+hx,1-hy,jm+hy,lm,km,km_all)
        ...
        call sup_vrbeta1T_new(km3_all,hx,hy,hz,im,jm,lm, pasp1,ss1,VALL)
...
!T      call S2C_ens(VALL,VM3D,1-hx,im+hx,1-hy,jm+hy,lm,km,km_all)
!T        call sup_vrbeta1(km3_all,hx,hy,hz,im,jm,lm,pasp1,ss1,VM3D)
!T      call C2S_ens(VM3D,VALL,1-hx,im+hx,1-hy,jm+hy,lm,km,km_all)

        call sup_vrbeta1_new(km3_all,hx,hy,hz,im,jm,lm, pasp1,ss1,VALL)
