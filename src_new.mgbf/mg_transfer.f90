...
!real(r_kind), pointer, dimension(:,:,:):: VLOC  

!----------------------------------------------------------------------
       VALL=0.

!    allocate(VLOC(km_all,1-ib:im+ib,1-jb:jm+jb))                      


!T                                                 call btim(  aintp_tim)

!      VLOC=0.
         call lsqr_adjoint_offset(WORK,VALL(1:km_all,1-ib:im+ib,1-jb:jm+jb),km_all)
...
!***
         ...
         call bocoT_2d(VALL(1:km_all,1-ib:im+ib,1-jb:jm+jb),km_all,im,jm,ib,jb)

                                                 call etim(  bocoT_tim)
 
!       VALL=0.
!       VALL(1:km_all,1:im,1:jm)=VLOC(1:km_all,1:im,1:jm)
...
!    allocate(VLOC(1:km_all,1-ib:im+ib,1-jb:jm+jb))                     

!      VLOC=0.
!      VLOC(1:km_all,1:im,1:jm)=VALL(1:km_all,1:im,1:jm)
...
!***
                                                 call btim(  boco_tim)
         call boco_2d(VALL(1:km_all,1-ib:im+ib,1-jb:jm+jb),km_all,im,jm,ib,jb)
...
!T                                                 call btim(   intp_tim)
         ...
         call lsqr_direct_offset(VALL(1:km_all,1-ib:im+ib,1-jb:jm+jb),WORK,km_all)
